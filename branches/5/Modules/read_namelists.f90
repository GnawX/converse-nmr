...
!
       ...
       spline_ps = .false.
       !
       ! UWG: spin-orbit coupling in GIPAW formalism
       lambda_so(:) = 0.d0
       align_spin = .true.
...
!=======================================================================
     ...
     SUBROUTINE system_bcast()
       ...
       !
       ! ... spin-orbit coupling in GIPAW style
       CALL mp_bcast( lambda_so,                 ionode_id, intra_image_comm )
       CALL mp_bcast( align_spin,                ionode_id, intra_image_comm )
       !CALL mp_bcast( reconstruction_only,       ionode_id, intra_image_comm )
       !CALL mp_bcast( read_recon_in_paratec_fmt, ionode_id, intra_image_comm )
       !CALL mp_bcast( file_reconstruction,       ionode_id, intra_image_comm )
       !
