...
SUBROUTINE h_psi( lda, n, m, psi, hpsi )
  ...
  !
  ! ... the spin-orbit coupling in GIPAW style to the non-local potentials 
  ! 
  IF ( any(lambda_so /= 0.d0) ) call add_so_Fnl (lda, n, m, psi, hpsi)
  !IF ( any(m_0 /= 0.d0) ) call add_nmr_Fnl (lda, n, m, psi, hpsi)
