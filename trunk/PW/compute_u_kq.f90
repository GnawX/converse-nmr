...
!
!----------------------------------------------------------------------------
SUBROUTINE compute_u_kq( ik, q, iter, ethr_q )
  !----------------------------------------------------------------------------
  !
  ! ... diagonalize at k+q
  !
  ...
  USE gvect,                ONLY : g, nrxx, nr1, nr2, nr3, ngm, ecutwfc 
  ...
  ! kinetic energy (CONTROLLARE!)
  call g2_kin(ik)

  ! read in wavefunctions from the previous iteration
  CALL get_buffer(evc, nwordwfc, iunwfc, ik)

  !! randomize a little bit (smerding)
  !do i = 1, nbnd
  !  do ig = 1, npw
  !    rr = 0.01d0*(2.d0*rndm() - 1.d0)
  !    arg = tpi * rndm()
